...
* Il est obligatoire d'avoir son pseudonyme identique à celui du site (sadoj-rp.fr) sur l'ensemble des Discord SADoJ ainsi que sur FiveM. A savoir qu'il est possible de faire changer son pseudo sur le site.
* Il est obligatoire d'avoir une identité Rôle-Play différente du pseudonyme sur les supports (site, Discord, FiveM).
...
* Un membre qui a fait l'objet d'un vote de bannissement ou qui est parti de lui-même après avoir porté atteinte à l'intégrité de la communauté, de ses serveurs (jeux, Discord) ou de ses documents, pourra soumettre une demande de retour en deux étapes :
...
* Lorsqu'une décision, un changement ou une modification est prise par un groupe communautaire, auquel la communauté a délégué ce pouvoir, il est obligatoire que ce groupe annonce et explique ses choix.
...
* Tout vote (à choix multiple, binaire ou non) voit son résultat retenu uniquement s'il récolte la majorité absolue des votes exprimés. Les "Ne se prononce pas" ne comptent pas comme des votes exprimés.
  * Sont exclus les votes de la durée des sanctions temporaires où une règle spécifique s'applique.
...
* Pour toute élection de membres où plusieurs places sont disponibles, l'option "Aucun de la liste" doit apparaître dans le vote. Tout candidat recevant un nombre de voix égal ou inférieur à celui de l'option "Aucun de la liste" ne peut être retenu.
...
* Les débats sont autorisés uniquement dans les espaces prévus à cet effet : le **canal textuel Discord « #débats »**, le **salon conférence Débats sur Discord**, ou lors des **réunions**.
...
* Deux types de faute *(annoncé par la personne qui demande le vote)*
  ...
  * Faute communautaire (règlement communautaire)
    * Plus d'accès aux Discord, serveurs, sites
...
* En cas de sanction communautaire, perte du rôle SADoJ sur Discord et compte désactivé sur le site pour la durée de la sanction.
...
Un de ces deux critères est valide :
